...
public class InweViewActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        txtMainTitle.setText(R.string.guandian);
        ...
        lishizixun.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mActivity, InweViewHistoryActivity.class);
                keepTogo(intent);
            }
        });
        ...
        adapter = new InwehotNewsAdapter(this, data, new MultiItemTypeSupport<ArticleDetaileBean>() {
            ...
            public int getItemViewType(int position, ArticleDetaileBean articleDetaileBean) {
                return articleDetaileBean.getType()==12?1:0;
            }
        });
    ...
    protected void initData() {
        ZixunApi.getInweView(this, page, new JsonCallback<LzyResponse<ArticleListBean>>() {
            @Override
