...
import com.inwecrypto.wallet.common.widget.MyLineChart;
import com.inwecrypto.wallet.common.widget.MyMarkeView;
...
public class MarketDetaileActivity extends BaseActivity {
    ...
    private void initChart() {
        ...
        xAxis.setTextColor(Color.parseColor("#333333"));//设置字体颜色
...
//        设置x轴显示标签数量  还有一个重载方法第二个参数为布尔值强制设置数量 如果启用会导致绘制点出现偏差
        ...
        xAxis.setAxisLineColor(Color.parseColor("#333333"));//设置x轴线颜色
...
//        xAxis.setDrawGridLines(true);//设置x轴上每个点对应的线
        ...
        leftAxis.setTextColor(Color.parseColor("#333333"));//设置字体颜色
        leftAxis.setDrawGridLines(false);
        leftAxis.setAxisLineColor(Color.parseColor("#333333"));//设置x轴线颜色
    ...
    protected void initData() {
        ...
        if (null != market.getRelationCap()) {
            ...
            if (market.getRelationCap().getPercent_change_24h().contains("-")) {
                ...
                tvRate.setBackgroundColor(Color.parseColor("#E86438"));
            } else {
                tvRate.setText("+" + market.getRelationCap().getPercent_change_24h() + "%");
                tvRate.setBackgroundColor(Color.parseColor("#008C55"));
            }
        }
...
//        } else {
        ...
        set.setColor(Color.parseColor("#E86438"));
        set.setValueTextColor(Color.parseColor("#E86438"));
        set.setCircleColorHole(Color.parseColor("#E86438"));
        set.setCircleColor(Color.parseColor("#E86438"));
        ...
        set.setHighLightColor(Color.parseColor("#333333"));//设置点击交点后显示交高亮线的颜色
        set.setVisible(true);
