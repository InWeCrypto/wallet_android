...
public class TradingNoticeActivity extends BaseActivity {
    ...
    private TradingNoticeAdapter adapter;
    ...
    protected void initView() {
        ...
        txtMainTitle.setText(R.string.jiaoyitixing);
        ...
        adapter=new TradingNoticeAdapter(this,R.layout.jiaoyitixing_item,data);
