...
import com.inwecrypto.wallet.ui.browser.BrowserFragment;
import com.inwecrypto.wallet.ui.discover.adapter.IcoWalletAdapter;
...
import com.inwecrypto.wallet.ui.wallet.activity.ClodAddWalletListActivity;
import com.inwecrypto.wallet.ui.wallet.activity.ColdWalletActivity;
...
public class MainTabActivity extends BaseActivity implements TabHost.OnTabChangeListener {
    ...
    private void initTabData() {
        ...
        tabItemList.add(new TabItem(R.mipmap.tab_faxian_nor
                , R.mipmap.tab_faxian_pre, R.string.faxian, InfoFragment.class));
    ...
    protected void EventBean(BaseEventBusBean event) {
        ...
        if (event.getEventCode() == Constant.EVENT_DRAWLAYOUT) {
    ...
    class TabItem {
        ...
        public void setChecked(boolean isChecked) {
            ...
            if (textView != null && title != 0) {
                if (isChecked) {
                    textView.setTextColor(getResources().getColor(R.color.c_008c55));
                } else {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            InfoFragment fragment = (InfoFragment) getSupportFragmentManager().findFragmentByTag(tabItemList.get(1).getTitleString());
            if (null!=fragment&&fragment.isVisible()&&fragment.needBack()){
                return true;
            }
