...
public class AddNeoWalletClodNfcActivity extends BaseActivity {
    ...
    protected void getBundleExtras(Bundle extras) {
        ...
        keystore=extras.getString("json");
        json=keystore.getBytes();
        ...
        WalletApi.wallet(mActivity,type_id, name, address, new JsonCallback<LzyResponse<CommonRecordBean<WalletBean>>>() {
            ...
            public void onSuccess(final Response<LzyResponse<CommonRecordBean<WalletBean>>> response) {
                ...
                mActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        hideLoading();
                        AppManager.getAppManager().finishActivity(AddNeoWalletClodSettingActivity.class);
