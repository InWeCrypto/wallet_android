...
public class MarketActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        adapter=new MarketAdapter(this,R.layout.market_item_market,markets);
    ...
    protected void initData() {
        ...
        MarketApi.market(this, new JsonCallback<LzyResponse<CommonListBean<MarkeListBean>>>() {
            @Override
    ...
    private void showSelectDialog() {
        ...
        View selectPopupWin = LayoutInflater.from(this).inflate(R.layout.view_popup_market, null, false);
        ...
        window.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                WindowManager.LayoutParams lp = MarketActivity.this.getWindow()
                        .getAttributes();
                lp.alpha = 1f;
                MarketActivity.this.getWindow().addFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
                MarketActivity.this.getWindow().setAttributes(lp);
            }
        });
