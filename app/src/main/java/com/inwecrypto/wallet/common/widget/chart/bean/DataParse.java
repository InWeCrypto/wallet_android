package com.inwecrypto.wallet.common.widget.chart.bean;
...
public class DataParse {
     ...
     * @param list
     */
    public void parseKLine(ArrayList<KLBean> list) {
        ...
        if (list != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                kLineData.low = Float.parseFloat( dayData.getMin_price());
                kLineData.vol = Float.parseFloat(dayData.getVolume());
