...
/**
 * Created by donghaijun on 2017/11/2.
 */
...
public class MaterialDialog {
    ...
    public MaterialDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mTouchOutCancel = cancel;
        if (mBuilder != null) {
            mBuilder.setCanceledOnTouchOutside(mTouchOutCancel);
        }
        return this;
    }
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            mAlertDialog.setCanceledOnTouchOutside(mTouchOutCancel);
        ...
        public void setCancelable(boolean canceleble) {
            mAlertDialog.setCancelable(canceleble);
        }
    }
