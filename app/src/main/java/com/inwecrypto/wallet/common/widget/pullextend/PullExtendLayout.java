package com.inwecrypto.wallet.common.widget.pullextend;
...
public class PullExtendLayout extends LinearLayout implements IPullToExtend {
     ...
     * 阻尼系数
     */
    private float offsetRadio = 1.6f;
    ...
    private void init(Context context) {
        mTouchSlop = (int) (ViewConfiguration.get(context).getScaledTouchSlop() * 0.7);
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (null!=recyclerView){
            topRowVerticalPosition= null==recyclerView?-1:((recyclerView.getChildCount() == 0) ? 0 : recyclerView.getChildAt(0).getTop());
        }
        boolean b2=(topRowVerticalPosition>= 0);
        boolean b1=mHeaderLayout.getState().name().equals("arrivedListHeight");
